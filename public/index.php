        ...
        <div class="row py-3 border-bottom">
          ...
          <div class="col-sm-4 col-lg-2 text-center text-sm-start d-flex gap-3 justify-content-center justify-content-md-start">
            <div class="d-flex align-items-center my-3 my-sm-0">
              <a href="index.html">
                <img src="images/logo1.png" alt="logo" class="img-fluid" style="width: 100px">
              </a>
            </div>
          </div>
    
          <div class="col-12 col-lg-4">
            <div class="search-bar input-group rounded-4 shadow-sm p-1">
              <input type="text" class="form-control border-0 bg-transparent" placeholder="Buscar productos..." aria-label="Buscar productos" aria-describedby="search-icon">
              <button class="btn border-0" id="search-icon">
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <section style="background-image: url('images/banner.jpeg');background-repeat: no-repeat;background-size: cover;">
      <div class="container-lg">
        ...
        <div class="row row-cols-1 row-cols-sm-3 row-cols-lg-3 g-0 justify-content-center">
          <div class="col">
            <div class="card border-0 rounded-0 p-4 text-light" style="background-color: rgb(31, 1, 78)">
              <div class="row">
                ...
                <div class="col-md-9">
                  <div class="card-body p-0">
                    <h5 class="text-light">Ahorro de Tiempo</h5>
                    <p class="card-text">Medicinas Disponibles 24/7
                      <br><br>
                    </p>
                  </div>
                </div>
          ...
          <div class="col">
            <div class="card border-0 rounded-0 p-4 text-light" style="background-color: rgb(6, 25, 82)">
              <div class="row">
                <div class="col-md-3 text-center">
                ...
                <div class="col-md-9">
                  <div class="card-body p-0">
                    <h5 class="text-light">Medicamentos Naturales</h5>
                    <p class="card-text">Origen 100% natural</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="col">
          <div class="card border-0 rounded-0 p-4 text-light" style="background-color: rgb(1, 78, 78)">
            <div class="row">
              <div class="col-md-3 text-center">
              ...
              <div class="col-md-9">
                <div class="card-body p-0">
                  <h5 class="text-light">Servicio a Domicilio</h5>
                  <p class="card-text">Envio Gratuito. Consulta tu número local</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="col">
                <div class="product-item">
                  ...
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">nombre del producto</h3>

                    <div class="d-flex justify-content-center align-items-center gap-2">

                      <span class="text-dark fw-semibold">$precio</span>
                      <span class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary"></span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="banner-blocks">
              ...
              <div class="banner-ad d-flex bg-success-subtle large bg-info block-1" style="background: url('images/banner-ad-1.jpg') no-repeat; background-size: cover;">
                <div class="banner-content align-items-center p-5" style="background: rgba(0, 0, 0, 0.5); padding: 10px; border-radius: 5px;">
                    <div class="content-wrapper text-light" style="text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);">
                        <h3 class="banner-title text-light">Tenemos los mejores productos en el Mercado                </h3>
            ...
            <div class="banner-ad bg-success-subtle block-2" style="background: url('images/banner-ad-2.jpg') no-repeat; background-size: cover;">
              <div class="banner-content align-items-center p-5" style="background: rgba(0, 0, 0, 0.5); padding: 10px; border-radius: 5px;">
                  <div class="content-wrapper text-light" style="text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);">
                      <h3 class="banner-title text-light">Ventas 24/7 en la tienda</h3>
                      <p>Con el mejor Servicio</p>
                      <br>
                  </div>
              </div>
          </div>
            ...
            <div class="banner-ad bg-success-subtle block-3" style="background: url('images/images.jfif') no-repeat; background-size: cover;">
                <div class="banner-content align-items-center p-5" style="background: rgba(0, 0, 0, 0.5); padding: 10px; border-radius: 5px;">
                    <div class="content-wrapper text-light" style="text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);">
                        <h3 class="banner-title text-light">Medicamentos de origen Natural</h3>
                        <p>Medicamentos de calidad</p>
                    </div>
                </div>
            </div>
        ...
        <div class="container-lg">
          <div class="row">
            <div class="col-md-12 copyright">
              ...
              <p><center>© 2024 Organic. All rights reserved.</center></p>
            </div>
